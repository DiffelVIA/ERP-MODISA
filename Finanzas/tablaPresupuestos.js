(() => {
  ...
  async function cargarProyectosActivos() {
    try {
      ...
      if (tbody) {
        tbody.innerHTML = `<tr><td colspan="18" style="text-align:center; padding:20px; color:red; font-weight:bold;">Error al obtener la lista de proyectos activos del servidor.</td></tr>`;
      }
    }
  }
