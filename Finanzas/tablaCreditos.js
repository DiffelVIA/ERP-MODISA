(() => {
    ...
    function generarFiltrosDropdown(datos) {
        ...
        fillingContenedorFiltro('filtroObra', obras, 'obra');
        fillingContenedorFiltro('filtroProveedor', proveedores, 'proveedor');
        fillingContenedorFiltro('filtroEstado', estados, 'estado');
    }

    function fillingContenedorFiltro(idContenedor, elementos, tipo) {
