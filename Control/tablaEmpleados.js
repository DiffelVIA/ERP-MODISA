        ...
        listaEmpleados.forEach(emp => {
            ...
            tr.innerHTML = `
                ...
                <td style="text-align: center;">
                    <button class="btn btn-editar" data-id="${emp.id_employee}" style="padding: 2px 8px; font-size: 12px;">✏️ Editar</button>
                    <button class="btn btn-eliminar" data-id="${emp.id_employee}" style="padding: 2px 8px; font-size: 12px; background: #dc2626; color: #fff;">🗑️ Eliminar</button>
                </td>
            `;
    ...
    function configurarEventos() {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            const payload = {
                ...
                last_name: document.getElementById('emp-apellido').value,
                email: document.getElementById('emp-email').value,
                phone: document.getElementById('emp-telefono').value,
                job_title: document.getElementById('emp-puesto').value,
                department: document.getElementById('emp-depto').value,
            };
